...
verifier -p <dradis_project_id> verify -i x-xss-protection -t https://example.com
----

Export
----
verifier -p <dradis_project_id> verify -x output.json -i x-xss-protection -t https://example.com
----

Import
----
verifier import output.json
verifier -p <dradis_project_id> import output.json
----
...
----
start_test --help
start_test -p <dradis_project_id> example.com
start_test -p <dradis_project_id> -l nl example.com
----
